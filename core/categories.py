...
categories = {
	...
	['ace-voip', 'amap', 'automater', 'braa', 'casefile', 'cdpsnarf', 'cisco-torch', 
	...
	'eapmd5pass', 'fern-wifi-cracker', 'ghost-phisher', 'gqrx', 'hostapd-wpe', 'kalibrate-rtl',
	...
	4:['web_applications',
	['apache-users', 'arachni', 'bbqsql', 'blindelephant', 'cutycapt', 'davtest', 'deblaze', 
	...
	'skipfish', 'sqlmap', 'sqlninja', 'sqlsus', 'ua-tester', 'uniscan', 'webscarab',
	'websploit', 'wfuzz', 'wpscan', 'xsser', 'zaproxy']
	],

	5:['sniffing_spoofing',
	['dnschef', 'fiked', 'hamster-sidejack', 'hexinject', 'iaxflood', 'inviteflood', 'ismtp',
	...
	['cryptcat', 'cymothoa', 'dbd', 'dns2tcp', 'httptunnel', 'httptunnel', 'intersect', 'nishang', 'polenum',
	'powersploit', 'pwnat', 'ridenum', 'sbd', 'u3-pwn', 'webshells', 'weevely', 'winexe']
	],

	7:['reporting_tools',
	['casefile', 'cutycapt', 'dos2unix', 'dradis', 'keepnote', 'metagoofil', 'nipper-ng', 'pipal']
	],
	...
	'volatility', 'xplico', 'foremost', 'galleta', 'guymager', 'p0f', 'pdf-parser', 
	...
	11:['password_attacks',
	['cewl', 'chntpw', 'cisco-auditing-tool', 'cmospwd', 'creddump', 'crunch', 
